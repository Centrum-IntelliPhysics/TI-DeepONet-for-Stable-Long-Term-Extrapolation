...
class DeepONet(nn.Module):
    ...
    def setup(self):
        ...
        self.trunk_net = trunk_net(self.trunk_net_config, jnp.sin)
...
print("Training completed successfully! Moving on to plotting the loss curves.")
...
plt.grid(alpha = 0.3)
plt.legend(loc = 'best')
# plt.savefig(filepath + "/loss_plot_v2.jpeg", dpi = 800)
plt.close()
...
plt.tight_layout()
# plt.savefig(filepath + "/Error_acc_v2.jpeg", dpi=800)
plt.close()
