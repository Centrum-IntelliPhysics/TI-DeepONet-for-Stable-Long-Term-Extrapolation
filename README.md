...
This repository contains implementations and analyses for the experiments described in the paper. There are three different PDEs in the codes folder. Each case has 4 different accompanying Jupyter notebooks that implement the 4 different frameworks: (1) DeepONet Autoregressive, (2) DeepONet Full Rollout, (3) TI-DeepONet, and (4) TI(L)-DeepONet.
